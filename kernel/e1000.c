...
e1000_transmit(struct mbuf *m)
{
  ...
  //  tx_ring[tx_ring_idx].cmd = 0xff;
  tx_ring[tx_ring_idx].cmd |= E1000_TXD_CMD_EOP;
  tx_ring[tx_ring_idx].cmd |= E1000_TXD_CMD_RS;
...
e1000_recv(void)
{
  ...
  while (1) {
    ...
    if ((rx_ring[rx_ring_idx].status & E1000_RXD_STAT_DD) == 0) {
      return;
    }
